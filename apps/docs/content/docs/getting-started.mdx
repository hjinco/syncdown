...
Open **Connectors → Apple Notes**.

If you are on macOS, enable Apple Notes sync. On the first run, macOS may ask you to grant Notes access to your current terminal or app.
