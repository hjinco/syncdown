...
- an Apple Notes connector for local notes on macOS
...
1. Connect supported services such as Notion, Gmail, Google Calendar, and Apple Notes.
...
- One Markdown file per readable local note
- Local macOS Notes access
- Account and folder-based output paths
- Re-runs that keep local Notes content in sync
